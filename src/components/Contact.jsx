...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <section
        id="sidenav"
        className={`bg-green-100 fixed z-20 top-0 transition-all duration-1000 ${isNavOpen ? 'right-0' : 'right-[-50%]'}`}
        style={{ width: '50%', height: '100vh' }}
      >
        <div className="text-right p-5">
          <p id="closenav" className="inline cursor-pointer" onClick={toggleNav}>X</p>
        </div>
      </section>
